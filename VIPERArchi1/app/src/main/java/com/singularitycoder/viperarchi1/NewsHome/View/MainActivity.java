package com.singularitycoder.viperarchi1.NewsHome.View;
...
import com.singularitycoder.viperarchi1.NewsHome.NewsAdapter;
import com.singularitycoder.viperarchi1.NewsHome.NewsContract;
import com.singularitycoder.viperarchi1.NewsHome.Presenter.NewsPresenter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeClasses() {
        newsPresenter = new NewsPresenter(this, newsView);
    }
    ...
    private void setClickListeners() {
        ...
        newsAdapter.setOnNewsItemClicked(position -> newsPresenter.implementContractPresenter().showNewsDetail(position, getSupportFragmentManager()));
    }
